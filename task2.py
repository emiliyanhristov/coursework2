...
#y containing 0, 1, and 2, the labels of the events (0 - normal, 1 - data injection attack, 2 - command injection attack)
x = train_data.iloc[:, :-1]
y = train_data.iloc[:, -1]
...
def addPredictedValues():
    ...
    with open('TestingDataMulti.csv', 'r') as input_file:
    ...
    with open('TestingDataMulti.csv', 'w', newline='') as output_file:
